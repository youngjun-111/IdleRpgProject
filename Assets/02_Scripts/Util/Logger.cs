...
public static class Logger
{
    ...
    public static void Log(string msg)
    {
        UnityEngine.Debug.LogFormat("[{0} {1}]", System.DateTime.Now.ToString("HH:mm:ss"), msg);
    }

    [Conditional("DEV_VER")]
    public static void LogWarning(string msg)//워밍 로그함수
    {
        UnityEngine.Debug.LogWarningFormat("[{0} {1}]", System.DateTime.Now.ToString("HH:mm:ss"), msg);
    }
    public static void LogError(string msg)//에러 로그함수
    {
        UnityEngine.Debug.LogErrorFormat("[{0} {1}]", System.DateTime.Now.ToString("HH:mm:ss"), msg);
    }
}
